...
const diseaseCatalog = {
	'type-2-diabetes': {
		...
		affectedRegions: [
			{ id: 'metabolic-area', label: 'Metabolic Area', cx: 50, cy: 32, rx: 12, ry: 12 },
		],
		markers: [
			{
				gene: 'TCF7L2',
	...
	'crohns-disease': {
		...
		affectedRegions: [{ id: 'intestine', label: 'Intestine', cx: 50, cy: 45, rx: 12, ry: 12 }],
		markers: [
			{
				gene: 'NOD2',
				rsId: 'rs2066844',
	...
	'alzheimers-disease': {
		...
		affectedRegions: [{ id: 'brain', label: 'Brain', cx: 50, cy: 4, rx: 10, ry: 10 }],
		markers: [
			{
				gene: 'APOE',
				rsId: 'rs429358',
