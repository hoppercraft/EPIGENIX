...
const diseaseCatalog = {
	'type-2-diabetes': {
		...
		affectedRegions: [
			{ id: 'pancreas', label: 'Pancreas', cx: 54, cy: 28, rx: 5, ry: 2.5 },
			{ id: 'liver', label: 'Liver', cx: 40, cy: 25, rx: 7, ry: 4 },
			{ id: 'adipose', label: 'Adipose tissue', cx: 50, cy: 38, rx: 10, ry: 6 },
		],
		markers: [
			{
				gene: 'TCF7L2',
	...
	'crohns-disease': {
		...
		affectedRegions: [{ id: 'intestine', label: 'Intestine', cx: 50, cy: 40, rx: 10, ry: 8 }],
		markers: [
			{
				gene: 'NOD2',
				rsId: 'rs2066844',
	...
	'alzheimers-disease': {
		...
		affectedRegions: [{ id: 'brain', label: 'Brain', cx: 50, cy: -12, rx: 8, ry: 10 }],
		markers: [
			{
				gene: 'APOE',
				rsId: 'rs429358',
