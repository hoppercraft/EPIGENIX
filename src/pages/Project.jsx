	...
	return (
		<div className="flex min-h-screen flex-col bg-background">
			...
			<div className="grid flex-1 md:grid-cols-[18rem_1fr]">
				...
				<main className="border-l border-outline-variant/60 bg-surface-lowest/55 p-6 shadow-glass backdrop-blur-glass sm:p-10">
					...
					<section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
						{[{
							...
							<article
								key={card.title}
								className="rounded-2xl border border-outline-variant/60 bg-surface-lowest/70 p-5 shadow-sm"
							>
