        ...
        <main className="mx-auto grid max-w-2xl gap-5 px-6 py-16 text-center sm:px-10">
          ...
          <div className="mt-2 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-on-primary shadow-glass transition hover:opacity-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              Go to Main Project
            </button>
            <a
              className="inline-flex items-center justify-center rounded-full border border-outline-variant/70 bg-surface-lowest/70 px-6 py-3 text-sm font-semibold text-ink shadow-sm transition hover:bg-surface-lowest"
